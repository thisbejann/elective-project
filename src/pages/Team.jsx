  ...
  return (
    ...
    >
      <div className="mt-12 flex flex-col justify-between md:mt-3 ">
        ...
        <div className="flex items-center justify-center px-5 dark:bg-secondary-dark-bg md:m-10  md:p-10 lg:mt-[5rem] lg:px-[8rem]">
          ...
          <div className="flex w-full flex-col gap-5 lg:flex-row">
            ...
            <TeamProfile
              ...
              description="Jann Jaspher is a passionate front-end web developer with expertise in HTML, CSS, and JavaScript. I excel at creating visually stunning user interfaces and collaborating with designers and back-end developers. With a keen eye for design and a commitment to delivering high-quality code, I am able to create dynamic, interactive, and user-friendly websites."
            />
            <TeamProfile
              name="Vince Allen"
